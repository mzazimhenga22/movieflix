...
export default function FlixyAssistant({
    ...
    const tips = useMemo(() => (customTip ? [customTip] : screenConfig.tips), [customTip, screenConfig.tips]);
            ...
            <Pressable onPress={handlePress}>
                ...
                >
                    ...
                    {!isExpanded && (
                        ...
                        >
                            <Text style={styles.tapHintText}>Assistant</Text>
                        </Animated.View>
                    )}
                </Animated.View>
            </Pressable>
