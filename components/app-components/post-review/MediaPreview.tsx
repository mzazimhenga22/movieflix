...
import FeedMusicPicker from './FeedMusicPicker';
...
export default function MediaPreview({
  ...
  const handleMusicSelect = (track: { videoId: string; title: string; artist: string; thumbnail: string; startTime?: number }) => {
    setReviewData(d => ({ ...d, musicTrack: track }));
    setMusicModalVisible(false);
  };

  const handleMusicRemove = () => {
    setReviewData(d => ({ ...d, musicTrack: null }));
  };
  ...
  return (
    ...
    <View style={styles.fullScreenWrapper}>
          ...
          <View style={styles.container}>
            ...
            <View style={[styles.formContainer, { bottom: Math.max(92, insets.bottom + 96) }]}>
                ...
                <View style={styles.optionsContainer}>
                    ...
                    <TouchableOpacity style={styles.optionButton} onPress={() => setMusicModalVisible(true)}>

                        <Ionicons name="musical-notes" size={20} color={reviewData.musicTrack ? '#e50914' : '#fff'} />

                        <Text style={[styles.optionText, reviewData.musicTrack && { color: '#e50914' }]} numberOfLines={1}>
                          {reviewData.musicTrack ? reviewData.musicTrack.title : 'Add Music'}
                        </Text>

                    </TouchableOpacity>
                    
                    {reviewData.musicTrack && (
                      <TouchableOpacity style={[styles.optionButton, styles.musicRemoveBtn]} onPress={handleMusicRemove}>
                          <Ionicons name="close-circle" size={20} color="#FF6B6B" />
                          <Text style={[styles.optionText, { color: '#FF6B6B' }]}>Remove Music</Text>
                      </TouchableOpacity>
                    )}
      ...
      {/* Music Picker Modal */}
      <Modal visible={isMusicModalVisible} transparent animationType="slide" onRequestClose={() => setMusicModalVisible(false)}>
        <View style={styles.musicModalContainer}>
          <Pressable style={styles.musicModalBackdrop} onPress={() => setMusicModalVisible(false)} />
          <View style={styles.musicModalContent}>
            <View style={styles.musicModalHeader}>
              <Text style={styles.musicModalTitle}>Add Music</Text>
              <TouchableOpacity onPress={() => setMusicModalVisible(false)} style={styles.musicCloseBtn}>
