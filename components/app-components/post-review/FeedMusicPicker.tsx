...
export default function FeedMusicPicker({
    previewUri,
    previewType,
    accent = '#e50914',
    onSelect,
    ...
    const handleSearch = useCallback(async (text: string) => {
        ...
        debounceRef.current = setTimeout(async () => {
            try {
                ...
                console.warn('[FeedMusicPicker] Search error:', err);
            }
        }, 400);
    }, [searchMusic]);
    ...
    const handlePreview = useCallback(async (track: MusicTrack) => {
        ...
        try {
            ...
            if (streamResult?.uri) {
                ...
                // Auto-stop after 30 seconds (feed preview)
                setTimeout(async () => {
                    if (soundRef.current) {
            ...
            console.warn('[FeedMusicPicker] Preview error:', err);
        } finally {
        ...
        <View style={styles.container}>
            ...
            {previewUri && (
                <View style={styles.previewSection}>
                    <View style={styles.previewContainer}>
                        ...
                        {/* Select Button */}
                        {selectedTrack && (
                            <TouchableOpacity style={styles.selectButton} onPress={handleUseTrack}>
                                <LinearGradient
                                ...
                                >
                                    ...
                                    <Text style={styles.selectButtonText}>Use this song</Text>
                                </LinearGradient>
                            </TouchableOpacity>
                        )}
                    </View>
            ...
            {loading ? (
                ...
                <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptyTitle}>Add music to your post</Text>
                    <Text style={styles.emptyText}>Search for a song to add to your post</Text>
                </View>
            )}
        </View>
    );
