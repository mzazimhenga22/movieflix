...
import { Animated, PixelRatio, Platform, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
          ...
          <Animated.View style={[styles.actionsRow, { opacity: contentAnim }]}>
            ...
            <TouchableOpacity style={styles.secondaryButton} activeOpacity={0.8}>
              <LiquidGlass
                ...
                glowIntensity={0.5}
                borderWidth={1}
                style={styles.secondaryButtonLiquid}
                animated={false}
              >
            ...
            <TouchableOpacity style={styles.shareButton} activeOpacity={0.8}>
              <LiquidGlass
                ...
                glowIntensity={0.5}
                borderWidth={1}
                style={styles.shareButtonLiquid}
                animated={false}
              >
