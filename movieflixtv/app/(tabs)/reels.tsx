...
import { LiquidChipView, LiquidGlassCard, LiquidShimmer } from '../../components/app-components/LiquidNativeViews';
...
const TvReelItem = React.memo(function TvReelItem({ 
    item, 
    isCurrent, 
    isVideoFocused, 
    muted, 
    ...
    useEffect(() => {
        if (isCurrent && isVideoFocused) {
            player.play();
        } else {
            player.pause();
        }
    }, [isCurrent, isVideoFocused, player]);
    ...
    return (
        <VideoView
            ...
            contentFit={isWidescreen ? 'contain' : 'cover'}
