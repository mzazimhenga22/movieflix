...
import { LiquidGlassCard, LiquidChipView, LiquidShimmer } from '../../components/app-components/LiquidNativeViews';
  ...
  return (
    <View style={styles.container}>
      <View style={StyleSheet.absoluteFill}>
        ...
        />
        <NativeTvGlowView color={accent} style={StyleSheet.absoluteFill} />
      </View>
          ...
          <View style={styles.panelInner}>
            <View style={styles.topBar}>
              ...
              <View style={styles.metaRow}>
                <LiquidChipView text={`${downloads.length} items`} size="small" />
                <LiquidChipView text={`${activeDownloads.length} active`} size="small" />
                <LiquidChipView text={formatBytes(totalBytes)} size="small" />
              </View>
            </View>

            {activeDownloads.length ? (
              <LiquidGlassCard style={styles.activeCard}>
