...
import { LiquidChipView } from '../../components/app-components/LiquidNativeViews';
...
const GenreChip = memo(function GenreChip({
  ...
  // Use native LiquidChipView on Android for better performance
