...
import TvGlassPanel from './TvGlassPanel';
import { TvFocusable } from './TvSpatialNavigation';
import { LiquidGlassButton } from '@/components/app-components/LiquidNativeViews';
    ...
    <View style={styles.inner}>
      ...
      <View style={styles.topBadgesRow}>
        ...
        <TvFocusable
          ...
          style={({ focused }: any) => [styles.myListBtnWrap, focused && styles.myListBtnWrapFocused]}
        >
          <TvGlassPanel borderRadius={22} compact native pro animated glowIntensity="subtle" accent={accent} style={styles.myListBtn}>
      ...
      <View style={[styles.content, isPanel ? styles.contentPanel : null]}>
        ...
        <View style={[styles.actions, isPanel ? styles.actionsPanel : null]}>
          {/* Native Liquid Glass Buttons for premium feel */}
          {Platform.OS === 'android' ? (
            <>
              <LiquidGlassButton
                icon="play"
            ...
            <>
              <TvFocusable
                ...
                onFocus={() => setIsFocused(true)}
                onBlur={() => setIsFocused(false)}
                style={({ focused }: any) => [styles.primaryBtnWrap, focused ? styles.btnFocused : null]}
                isTVSelectable={true}
                tvPreferredFocus={isPanel}
                accessibilityLabel={primaryLabel}
              >
                <TvGlassPanel borderRadius={16} compact native pro interactive animated glowIntensity="strong" accent={accent} style={[styles.primaryBtn, { borderColor: `${accent}55` }]}>
              ...
              <TvFocusable
                ...
                onFocus={() => setIsFocused(true)}
                onBlur={() => setIsFocused(false)}
                style={({ focused }: any) => [styles.secondaryBtnWrap, focused ? styles.btnFocused : null]}
                isTVSelectable={true}
                accessibilityLabel={secondaryLabel}
              >
                <TvGlassPanel borderRadius={16} compact native pro animated glowIntensity="medium" accent={accent} style={styles.secondaryBtn}>
              ...
              <TvFocusable
                ...
                onFocus={() => setIsFocused(true)}
                onBlur={() => setIsFocused(false)}
                style={({ focused }: any) => [styles.tertiaryBtnWrap, focused ? styles.btnFocused : null]}
                isTVSelectable={true}
                accessibilityLabel={tertiaryLabel}
              >
                <TvGlassPanel borderRadius={16} compact native pro animated glowIntensity="medium" accent={accent} style={styles.tertiaryBtn}>
