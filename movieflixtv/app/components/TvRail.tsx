...
import NativeFastMovieRail from '@/components/NativeFastMovieRail';
...
export default function TvRail({
  ...
  // Use native FastMovieRail on Android for buttery smooth TV remote scroll
  if (Platform.OS === 'android' && !isTop10) {
    return (
