          ...
          >
            ...
            <View style={styles.inputRow}>
              <View style={styles.leftActions}>
                {/* Emoji button with Liquid Glass */}
                <Pressable
                ...
                >
                  <LiquidGlass
                    glowColor={showEmojis ? accent : '#ffffff'}
                    tintColor="#2A1A3E"
                    tintOpacity={showEmojis ? 0.6 : 0.3}
                    cornerRadius={19}
                    glowIntensity={0.5}
                    borderWidth={1}
                ...
                {/* Attachment button with Liquid Glass */}
                <Pressable
                  style={styles.roundButton}
                  disabled={disabled}
                  onPress={handlePlus}
                >
                  <LiquidGlass
                    glowColor={showAttachSheet ? accent : '#ffffff'}
                    tintColor="#2A1A3E"
                    tintOpacity={showAttachSheet ? 0.6 : 0.3}
                    cornerRadius={19}
                    glowIntensity={0.5}
                    borderWidth={1}
                    style={styles.roundButtonGlass}
              ...
              {/* Send/Mic button with Liquid Glass */}
              <Pressable
              ...
              >
                <LiquidGlass
                  glowColor={hasText || recordedUri ? accent : '#ffffff'}
                  tintColor={hasText || recordedUri ? accent : '#2A1A3E'}
                  tintOpacity={hasText || recordedUri ? 0.85 : 0.4}
                  cornerRadius={22}
                  glowIntensity={hasText || recordedUri ? 0.8 : 0.4}
                  borderWidth={1}
